...
class BestLabApi {
    constructor() {
        this.baseURL = `${API_BASE_URL}/api/bestlab`;
    }
    ...
    // 9. Kiểm tra quyền truy cập BestLab link
